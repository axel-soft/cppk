...
Процедура УстановкаПараметровСеанса(ИменаПараметровСеанса)
	...
	Если ИменаПараметровСеанса = Неопределено
		Или ИменаПараметровСеанса.Найти("ЭтоУдалениеПомеченных") <> Неопределено Тогда
		
		ПараметрыСеанса.ЭтоУдалениеПомеченных = Ложь;
	...
	// КОД
	КОДСобытия.УстановкаПараметровСеанса(ИменаПараметровСеанса);
	// Конец КОД
