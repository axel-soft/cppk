...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтложенноеОбновлениеПрав = Константы.ДокументооборотИспользоватьОтложенноеОбновлениеПравДоступа.Получить();
...
Процедура ПриОткрытии(Отказ)
	Если ОтложенноеОбновлениеПрав Тогда
		ПодключитьОбработчикОжидания("ОбновитьСведенияОбОчередиОбработчикОжидания", 5);
	КонецЕсли;
КонецПроцедуры
