...
Процедура УстановитьЗаголовокПодсказкиУсовершенствования()
	...
	Если ЗначениеЗаполнено(КонстантаТипПодписиКриптографииПоУмолчанию) Тогда
		...
		Элементы.ГруппаУсовершенствоватьПодписи.Доступность = 
			КонстантаТипПодписиКриптографииПоУмолчанию <> ПредопределенноеЗначение("Перечисление.ТипыПодписиКриптографии.ОбычнаяCMS")
			И КонстантаТипПодписиКриптографииПоУмолчанию <> ПредопределенноеЗначение("Перечисление.ТипыПодписиКриптографии.БазоваяCAdESBES");
