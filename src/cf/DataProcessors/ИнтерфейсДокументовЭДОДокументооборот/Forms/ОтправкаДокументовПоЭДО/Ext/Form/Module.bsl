...
Процедура УстановитьВидимостьКоманд(ДоступныеДействия)
	...
	Если ДоступныеДействия[ВозможныеДействия.Подписать] = Истина Тогда
		
		Элементы.Подписать.Видимость = Истина;
		Элементы.Подписать.Доступность = Истина;
		
		Если ДоступныеДействия[ВозможныеДействия.Отправить] = Истина Тогда
			Элементы.ПодписатьИОтправить.Видимость = Истина;
			Элементы.ПодписатьИОтправить.Доступность = Истина;
		КонецЕсли;
		
	ИначеЕсли ДоступныеДействия[ВозможныеДействия.Отправить] = Истина Тогда 
	...
	Если ДоступныеДействия[ВозможныеДействия.СоздатьПакет] = Истина Тогда
		Элементы.СоздатьПакет.Видимость = Истина;
		Элементы.СоздатьПакет.Доступность = Истина;
	КонецЕсли;
	
	Если ДоступныеДействия[ВозможныеДействия.ДобавитьКПакету] = Истина Тогда
		Элементы.ДобавитьКПакету.Видимость = Истина;
		Элементы.ДобавитьКПакету.Доступность = Истина;
	КонецЕсли;
	
	Если ДоступныеДействия[ВозможныеДействия.ИзменитьСоставПакета] = Истина Тогда
