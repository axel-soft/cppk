...
// Новая функциональность настройки отправки документов.
// 
// Возвращаемое значение:
//  Структура - Новая функциональность настройки отправки документов:
// * КомандаРасширенныйРежим - Булево - 
// * КолонкаРегламентЭДО - Булево - 
// * ПолеДоговорКонтрагента - Булево - 
//
Функция НоваяФункциональностьНастройкиОтправкиДокументов()
	
	Функциональность = Новый Структура;
	Функциональность.Вставить("КомандаРасширенныйРежим", Истина);
	Функциональность.Вставить("КолонкаРегламентЭДО", Истина);
	Функциональность.Вставить("ПолеДоговорКонтрагента", Истина);
...
// 
// Возвращаемое значение:
//  Структура - Доступная функциональность формы "НастройкаОтправкиДокументов":
// * КомандаРасширенныйРежим - Булево - Истина, если функциональность доступна
// * КолонкаРегламентЭДО - Булево - Истина, если функциональность доступна
// * ПолеДоговорКонтрагента - Булево - Истина, если функциональность доступна
//
Функция ДоступнаяФункциональностьФормыНастройкаОтправкиДокументов() Экспорт
	
	Функциональность = НоваяФункциональностьНастройкиОтправкиДокументов();
	ОбменСКонтрагентамиПереопределяемый.ПриОпределенииДоступнойФункциональностиФормыНастройкиОтправкиДокументов(
		Функциональность);
...
Функция АктСверкиВзаиморасчетов_ИнформацияПолучателя_ДанныеУчета(Знач ОбъектУчета, Знач Параметры)
	...
	Если Не ЗначениеЗаполнено(ОбъектУчета) 
		И Не ПолучитьФункциональнуюОпцию("ЗапретитьФормированиеОтветногоТитулаБезДокументовУчета") Тогда
		Результат.ОшибкаФормированияВПрикладнойЧасти = Истина;
		Возврат Результат;
	КонецЕсли;
