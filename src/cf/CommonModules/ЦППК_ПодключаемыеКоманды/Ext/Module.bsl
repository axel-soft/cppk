...
Процедура ДобавитьЭлементыВноситИзменения(Форма) Экспорт
	...
	Если Элементы.Найти("ЦППК_ПолеНадписиВноситИзменения") = Неопределено Тогда	
		...
		НоваяГруппа.Поведение = ПоведениеОбычнойГруппы.Обычное;
			...
			НовыйЭлемент.Заголовок = "Изменен     " + Символ(160); //Символы.НПП);
			НовыйЭлемент.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Право;
			НовыйЭлемент.Видимость = Ложь;
...
// Вспомогательная процедура для добавления реквизитов таблицы
Процедура ДобавитьРеквизитТаблицы(
    МассивРеквизитов, 
    ИмяТаблицы, 
    ТипТаблицы, 
    ТипСправочника)
    ...
    МассивРеквизитов.Добавить(
        Новый РеквизитФормы(
            ИмяТаблицы, 
            Новый ОписаниеТипов(ТипТаблицы)));
                                                                                    
    МассивРеквизитов.Добавить(
        Новый РеквизитФормы(
            "Документ", 
            ОписаниеТипаСправочник(ТипСправочника), 
            ИмяТаблицы));
