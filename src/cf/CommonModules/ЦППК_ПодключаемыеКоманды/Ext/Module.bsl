...
Процедура ДокументыПредприятияПриСозданииНаСервереПеред(Форма) Экспорт
	...
	//++AxelSoft Котляров 02,07,2025
		...
		МассивРеквизитов.Добавить(Новый РеквизитФормы("ЦППК_СписокИзмененныхДокументов", Новый ОписаниеТипов("ТаблицаЗначений")));
                                                                                        
        МассивРеквизитов.Добавить(Новый РеквизитФормы("Документ", ОписаниеТипаСправочник("ДокументыПредприятия"), "ЦППК_СписокИзмененныхДокументов"));
        МассивРеквизитов.Добавить(Новый РеквизитФормы("ДатаОтмены", ОписаниеТипаДатаВремя("Дата"), "ЦППК_СписокИзмененныхДокументов"));
		МассивРеквизитов.Добавить(Новый РеквизитФормы("УжеУстановлен", ОписаниеТипаБулево(), "ЦППК_СписокИзмененныхДокументов"));
		МассивРеквизитов.Добавить(Новый РеквизитФормы("Источник", ОписаниеТипаСтрока(), "ЦППК_СписокИзмененныхДокументов"));
		
		МассивРеквизитов.Добавить(Новый РеквизитФормы("ЦППК_СписокИзмененныхДокументовНачальное", Новый ОписаниеТипов("ТаблицаЗначений")));
                                                                                        
        МассивРеквизитов.Добавить(Новый РеквизитФормы("Документ", ОписаниеТипаСправочник("ДокументыПредприятия"), "ЦППК_СписокИзмененныхДокументовНачальное"));
        МассивРеквизитов.Добавить(Новый РеквизитФормы("ДатаОтмены", ОписаниеТипаДатаВремя("Дата"), "ЦППК_СписокИзмененныхДокументовНачальное"));
		МассивРеквизитов.Добавить(Новый РеквизитФормы("УжеУстановлен", ОписаниеТипаБулево(), "ЦППК_СписокИзмененныхДокументовНачальное"));
		МассивРеквизитов.Добавить(Новый РеквизитФормы("Источник", ОписаниеТипаСтрока(), "ЦППК_СписокИзмененныхДокументовНачальное"));
...
Процедура ЦППК_ДобавитьЭлементыФормы_ВидыДокументов(Форма) Экспорт
	...
	НовыйЭлемент = Элементы.Вставить("ЦППК_УчитыватьВноситИзменения", Тип("ПолеФормы"), Элементы.ГруппаДополнительныеНастройки, Элементы.ФормаДокумента);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеФлажка;
...
Процедура ДобавитьЭлементыВноситИзменения(Форма) Экспорт
	...
	Если Элементы.Найти("ЦППК_ПолеНадписиВноситИзменения") = Неопределено Тогда	
		НовыйЭлемент = Элементы.Вставить("ЦППК_ПолеНадписиВноситИзменения", Тип("ДекорацияФормы"), Элементы.ГруппаРеквизиты, Элементы.ГрифДоступа);
		НовыйЭлемент.Вид = ВидДекорацииФормы.Надпись;
		НовыйЭлемент.Гиперссылка = Истина;
		...
		НоваяГруппа = Элементы.Вставить("ТТС_ГруппаИзменен", Тип("ГруппаФормы"), Элементы.ГруппаРеквизиты, Элементы.ЦППК_ПолеНадписиВноситИзменения);	
		НоваяГруппа.Вид = ВидГруппыФормы.ОбычнаяГруппа;
		...
		НоваяГруппа.Поведение = ПоведениеОбычнойГруппы.Обычное;
			...
			НовыйЭлемент.Заголовок = "Изменен     "+Символ(160);
			НовыйЭлемент.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Право;
			НовыйЭлемент.Видимость = Ложь;
