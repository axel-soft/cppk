...
Процедура ЦППК_ДобавитьЭлементыФормы_ВидыДокументов(Форма) Экспорт
	...
	// САНФ-036848   07.10.2025
	НовыйЭлемент = Элементы.Вставить("ЦППК_ВидимостьВкладкиУчетнаяИнформация", Тип("ПолеФормы"), 
																	  Элементы.ГруппаДополнительныеНастройки, Элементы.ФормаДокумента);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеФлажка;
	НовыйЭлемент.ПутьКДанным = "Объект.ЦППК_ВидимостьВкладкиУчетнаяИнформация";
	НовыйЭлемент.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Право;
	НовыйЭлемент.Заголовок = "Видимость вкладки Учетная информация";
