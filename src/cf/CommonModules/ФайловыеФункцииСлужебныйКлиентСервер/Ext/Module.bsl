...
Функция ПроверитьВозможностьЗагрузкиФайла(Файл,
	...
	РазрешеноДобавлятьФайлыТаймлист
		= ТаймлистВызовСервера.РазрешеноДобавлятьФайлыТаймлистПревышающихМаксимальноДопустимыйОбъем(
			Файл.Расширение, РазмерВМб);
	
	// Размер файла слишком большой.
	Если Файл.Размер() > ОбщиеНастройки.МаксимальныйРазмерФайла И Не РазрешеноДобавлятьФайлыТаймлист Тогда
...
Процедура ПроверитьРазмерФайлаДляЗагрузки(Файл) Экспорт
	...
	Если Размер > ОбщиеНастройки.МаксимальныйРазмерФайла И Не РазрешеноДобавлятьФайлыТаймлист Тогда
