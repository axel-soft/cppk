...
#Область Интеграция1СЭДОИ1СДокументооборот

// Заполняет данные участников ЭДО в исходящем формализованном документе ЭДО
// 
// Параметры:
...
Функция ПереформироватьДокументСогласноНастройкамОтправки(ДокументЭДО) Экспорт
	...
	Возврат ЭлектронныеДокументыЭДО.ПереформироватьДокументСогласноНастройкамОтправки(ДокументЭДО);
