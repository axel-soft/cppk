...
Функция ПолучитьУчетныеЗаписиЭлектроннойПочты(Знач ПараметрыОтбора = Неопределено) Экспорт
	...
	Если ПараметрыОтбора <> Неопределено Тогда
		...
		ПараметрыОтбора.Свойство("УзелОбработки", УзелОбработки);
	КонецЕсли;
	...
	Запрос.УстановитьПараметр("УзелОбработки", УзелОбработки);
	
	Если Не ЗначениеЗаполнено(УзелОбработки) Тогда
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "И УчетныеЗаписиЭлектроннойПочты.УзелОбработки = &УзелОбработки", "");
	КонецЕсли;	
