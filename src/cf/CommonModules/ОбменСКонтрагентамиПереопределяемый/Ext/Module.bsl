...
// При определении доступной функциональности формы "Настройки отправки документов"
// РС "НастройкиОтправкиЭлектронныхДокументовПоВидам".
// 
// Параметры:
//  ДоступнаяФункциональность см. ИнтеграцияЭДО.ДоступнаяФункциональностьФормыНастройкаОтправкиДокументов
//
Процедура ПриОпределенииДоступнойФункциональностиФормыНастройкиОтправкиДокументов(ДоступнаяФункциональность) Экспорт
	
	ДоступнаяФункциональность.КолонкаРегламентЭДО = Ложь;
	ДоступнаяФункциональность.КомандаРасширенныйРежим = Ложь;
	ДоступнаяФункциональность.ПолеДоговорКонтрагента = Ложь;
	
КонецПроцедуры

// Вызывается при определении способа отражения в учете УПД и УКД: Одним объектом учета или двумя (СФ/КСФ и Акт/Накладная/Корректировка)
// 
// Параметры:
//  ОтражатьОднимОбъектомУчета - Булево
Процедура ПриОпределенииОтраженияУниверсальныхДокументовОднимОбъектомУчета(ОтражатьОднимОбъектомУчета) Экспорт
	
	ОтражатьОднимОбъектомУчета = Истина;
