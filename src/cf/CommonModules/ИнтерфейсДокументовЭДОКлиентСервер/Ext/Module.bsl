...
// Конструктор пустых параметров обмена ЭДО для создания исходящего документа по файлу
// 
// Возвращаемое значение:
//  см. ОбменСКонтрагентамиКлиент.ПараметрыОбменаЭДОДляСозданияДокументаПоФайлу
