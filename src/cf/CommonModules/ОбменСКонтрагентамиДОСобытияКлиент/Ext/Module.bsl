...
Процедура УчетнаяЗаписьЭДОНажатие(Форма, Элемент, СтандартнаяОбработка) Экспорт
	...
	ОбменСКонтрагентамиДОХолдингКлиент.УчетнаяЗаписьЭДОНажатие(Форма, Элемент, СтандартнаяОбработка);
...
Процедура ПередУдалениемДокументаЭДОИзСпискаКСозданиюВДО(ДокументЭДО, Отказ) Экспорт
	...
	ОбменСКонтрагентамиДОХолдингКлиент.ПередУдалениемДокументаЭДОИзСпискаКСозданиюВДО(ДокументЭДО, Отказ);
...
Процедура ПередПостановкойДокументовЭДОКАвтоматическомуОтражению(ДокументыЭДО, Отказ) Экспорт
	...
	ОбменСКонтрагентамиДОХолдингКлиент.ПередПостановкойДокументовЭДОКАвтоматическомуОтражению(ДокументыЭДО, Отказ);
