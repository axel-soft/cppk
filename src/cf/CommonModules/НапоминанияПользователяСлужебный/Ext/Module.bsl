	...
	Попытка
		...
		Иначе
			Если НаборЗаписей.Количество() > 0 Тогда
				...
				Если ЗанятоеВремя.Найти(ПараметрыНапоминания.ВремяСобытия) <> Неопределено Тогда
					ДобавитьНапоминание = Ложь;
				КонецЕсли;
			КонецЕсли;
			Если ДобавитьНапоминание Тогда
				НоваяЗапись = НаборЗаписей.Добавить();
				ЗаполнитьЗначенияСвойств(НоваяЗапись, ПараметрыНапоминания);
			КонецЕсли;
		КонецЕсли;
		
		Если ДобавитьНапоминание И НаборЗаписей.Количество() > 0 Тогда
