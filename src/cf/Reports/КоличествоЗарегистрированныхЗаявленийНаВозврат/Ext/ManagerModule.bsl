...
Процедура ЗаполнитьСписокКатегорийИРазделовОтчета(КлючВариантаОтчета, СписокКатегорий, СписокРазделов) Экспорт
	...
	Если КлючВариантаОтчета = "КоличествоЗарегистрированныхЗаявленийНаВозврат" Тогда
		
		СписокКатегорий.Добавить(Справочники.КатегорииОтчетов.ПоЗаявкамНаВозврат_ТТС);
		СписокРазделов.Добавить(Перечисления.РазделыОтчетов.ЗаявкиНаВозвратСписок_ТТС);	
	КонецЕсли;		
КонецПроцедуры
