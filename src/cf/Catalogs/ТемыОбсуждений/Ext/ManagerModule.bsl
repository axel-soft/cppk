...
// Возвращает права сотрудников на объекты.
// 
Функция ПраваСотрудниковПоОбъектам(ОбъектыДоступа, СотрудникиОтбор = Неопределено) Экспорт
	...
	ТаблицаПравПоДескрипторам =
		РегистрыСведений.ПраваПоДескрипторамДоступаОбъектов.ПолучитьПраваСотрудниковПоОбъектам(
			ОбъектыДоступа, СотрудникиОтбор, Ложь);
	...
	ПраваПапок.Индексы.Добавить("ОбъектДоступа, Сотрудник");
	...
	Пока Выборка.Следующий() Цикл
		...
		Для Каждого СтрокаПравПоДескрипторам Из СтрокиПравПоДескрипторам Цикл
			...
			ЗаполнитьЗначенияСвойств(Стр, СтрокаПравПоДескрипторам, "ОбъектДоступа, Сотрудник, Чтение");
			...
			СтруктураПоиска = Новый Структура(
				"ОбъектДоступа, Сотрудник", Выборка.Папка, Стр.Сотрудник);
