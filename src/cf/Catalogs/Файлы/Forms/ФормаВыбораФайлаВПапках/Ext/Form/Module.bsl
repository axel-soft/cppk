...
Процедура ПроверитьПредельныйРазмерФайла(МаксРазмерФайла, РазмерФайла, РасширениеФайла, ФайлСсылка)
	...
	РазрешеноДобавлятьФайлыТаймлист = ТаймлистИспользуется
		И ТаймлистКлиентСервер.ЭтоРасширениеФайлаТаймлист(РасширениеФайла)
		И ДоступноРаспознаваниеТаймлист
		И РазмерВМб <= 1024;
	
	Если РазмерФайла > МаксРазмерФайла И Не РазрешеноДобавлятьФайлыТаймлист Тогда
