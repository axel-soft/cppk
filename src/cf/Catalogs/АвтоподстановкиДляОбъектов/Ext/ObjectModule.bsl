...
Процедура ПередЗаписью(Отказ)
	...
	ДополнительныеСвойства.Вставить(
		...
		Справочники.АвтоподстановкиДляОбъектов.ЗначенияПараметровОбновленияАдреснойКнигиПоОбъекту(ЭтотОбъект));
...
Процедура ПриЗаписи(Отказ)
	...
	// Обновление адресной книги.
	Справочники.АвтоподстановкиДляОбъектов.ОбновитьАдреснуюКнигу(
