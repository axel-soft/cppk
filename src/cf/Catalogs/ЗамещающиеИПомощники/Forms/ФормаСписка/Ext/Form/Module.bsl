...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		Отказ = Истина;
		ТекстОшибки = НСтр("ru = 
			|'Справочник ""Замещающие и помощники"" не предназначен для открытия через ""Функции для технического специалиста"".
			|Используйте команды пользовательского интерфейса.'");
