...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтборИсполнителиРолейДелегаты = ИсполнителиРолейИДелегатыСотрудника();
	...
	Список.Параметры.УстановитьЗначениеПараметра("МассивИсполнителейРолейИДелегатов", ОтборИсполнителиРолейДелегаты);
...
&НаСервере
Функция ИсполнителиРолейИДелегатыСотрудника()
	...
	Запрос.Текст =
		...
		|ГДЕ
		|	ИсполнителиРолейИДелегаты.ИсполнительДелегат = &Контролер
	...
	Запрос.УстановитьПараметр("Контролер", Сотрудники.ОсновнойСотрудник());
