...
Процедура ПоказатьВноситИзменения()
	...
	ЭтотВидМожетВноситьИзменения = ЦППК_ОбщийМодульКлиентСервер.ЦППК_ЭтотВидДокументаМожноИзменить(Объект.ВидДокумента);
...
Процедура ЦППК_ПолеНадписиВноситИзменения_Нажатие(Элемент)
	...
	ВидыИзмененныхДокументов = ЦППК_ОбщийМодульКлиентСервер.ЦППК_ПолучитьВидыИзмененныхДокументов(Объект.ВидДокумента);
	//
