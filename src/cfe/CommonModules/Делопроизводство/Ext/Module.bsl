...
#Область ФункцииВноситИзменения
			// переделки от МожетОтменять
...
Функция ЭтотВидДокументаМожноИзменить(ВидДокумента) Экспорт
	
	Если Не ЕстьЛиНастройкиСвязейИзмененДокументом() Тогда
		Возврат Истина;
	КонецЕсли;
	
	ВидыИзмененныхДокументов = ПолучитьВидыИзмененныхДокументов(ВидДокумента);
...
Функция ЕстьЛиНастройкиСвязейИзмененДокументом() Экспорт
...
Функция ПолучитьВидыИзмененныхДокументов(ВидДокумента) Экспорт
...
Функция ЭтотВидДокументаМожетВноситьИзменения(ВидДокумента) Экспорт
	
	Если Не ЕстьЛиНастройкиСвязейОтмены() Тогда
		Возврат Истина;
	КонецЕсли;
	
	ВидыОтменяющихДокументов = ПолучитьВидыИзмененныхДокументов(ВидДокумента);
...
Процедура УдалитьДанныеОбИзмененыхДокументах(Документ) Экспорт
