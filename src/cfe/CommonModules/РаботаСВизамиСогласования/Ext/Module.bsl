...
#Вставка
			...
			Попытка
				Если Предмет.ВидДокумента.ЯвляетсяДопСоглашением Тогда
					ОбластьШапка.Параметры.НаименованиеВидаДокумента = "Дополнительное соглашение";
				ИначеЕсли Предмет.ВидДокумента.ЯвляетсяДоговором тогда
					ОбластьШапка.Параметры.НаименованиеВидаДокумента = "Договор";	
				КонецЕсли;		
			Исключение
			КонецПопытки;	
#КонецВставки
