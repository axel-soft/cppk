...
&ИзменениеИКонтроль("ЗапуститьImageMagick")
Функция ЦППК_ЗапуститьImageMagick(Параметры, ФайлыКУдалению, ИмяBatФайла, СтрокаImageMagick, ТекущийКаталог)
...
// Ошибка при использовании 2 параметра - ТекущийКаталог
