...
Функция ЦППК_ЭтотВидДокументаМожетВноситьИзменения(ВидДокумента) Экспорт
	...
	ВидыОтменяющихДокументов = ЦППК_ПолучитьВидыИзмененныхДокументов(ВидДокумента);
...
&НаСервере
Процедура ЦППК_УдалитьДанныеОбИзмененыхДокументах(Документ) Экспорт
	...
	Для Каждого ОтменяемыйДок Из МассивДокументов Цикл
		РегистрыСведений.ЦППК_ИзмененныеДокументы.УдалитьДанные(Документ, ОтменяемыйДок.Документ);
	КонецЦикла;	
...
Процедура ЦППК_УстановитьИзменение(
	...
	Для Каждого СтрокаДокумент Из СписокДокументов Цикл 
		...
		НастройкаСвязи = СвязиОбъектов.ПолучитьНастройкуСвязи(Документ, СтрокаДокумент.Документ, Справочники.ТипыСвязей.ЦППК_ИзмененДокументом);	
		...
		СвязиОбъектов.СоздатьСвязь(Документ, СтрокаДокумент.Документ, Справочники.ТипыСвязей.ЦППК_ИзменяетДокумент, Установил, ДатаУстановки, Комментарий);
		СвязиОбъектов.СоздатьСвязь(СтрокаДокумент.Документ, Документ, Справочники.ТипыСвязей.ЦППК_ИзмененДокументом, Установил, ДатаУстановки, Комментарий);
